    ...
    <div className="p-5 h-screen w-screen flex space-x-7 relative">
      ...
      <div className="flex-[2.5] border p-5 flex flex-col space-y-5 bg-gray-50/50 z-20">
        ...
        <div className="h-1/2 p-5 flex space-x-5">
          <button className="w-1/2 bg-green-500 hover:bg-green-600 active:bg-green-400 border-4 border-green-600 active:border-green-400 shadow-lg rounded-3xl text-white flex justify-center items-center text-7xl font-bold uppercase tracking-widest">ready</button>
