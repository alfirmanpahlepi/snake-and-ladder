...
export default function Chat(): JSX.Element {
    ...
    return (
        <div className="flex flex-col h-full w-full">
            <ul className="flex-grow overflow-auto border bg-white/50 p-2 space-y-2">
                {messages.map((msg: Message, i: number): JSX.Element => (
                    <li key={i}>
                        <div className="flex items-center space-x-2">
                            <span style={{ backgroundColor: msg.color }}
...
const dummy = [
    {
        text: "halo nama saya Alfirman eja Pahlepi",
        user: "Alfirman eja Pahlepi",
        color: "#fcc"
    },
    {
        text: "halo nama saya Alfirman eja Pahlepi",
